...
Switch the layout with a single prop: `rows`, `columns`, or `masonry`. The playground above lets you compare the same photo set live instead of reading three nearly identical snippets.
...
::card-group
  ...
  Layouts guide
  #description
  Deep dive into rows, columns, and masonry.
  ::
