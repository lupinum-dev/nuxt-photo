...
git clone https://github.com/mat4m0/nuxt-photo.git
cd nuxt-photo
...
Tests are in `playground/tests/e2e/` and cover gallery rendering, lightbox interaction, all four layout types, headless mode, and `@nuxt/image` integration.
