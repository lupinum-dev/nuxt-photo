...
- **Layout algorithms** — Knuth-Plass row justification, shortest-path column distribution, and masonry greedy placement (see [Layout Algorithms](/advanced/layout-algorithms))
