...
Nuxt apps receive these imports from `@nuxt-photo/nuxt`. Explicit imports use `@nuxt-photo/nuxt/app`.
...
- [Layouts and responsiveness](/docs/concepts/layouts-and-responsiveness)
- [Control a lightbox programmatically](/docs/guides/control-a-lightbox-programmatically)
- [Lightbox primitives API](/docs/api/primitives)
