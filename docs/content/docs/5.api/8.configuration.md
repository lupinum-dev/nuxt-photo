...
Turn this off only if you want tight control over your imports or you are importing the composables manually. If app code imports from `@nuxt-photo/vue` directly, list `@nuxt-photo/vue` in your app dependencies.
