...
:::read-more{to="/docs/concepts/ssr-and-layout-stability" title="SSR and CLS"}
:::
...
:::read-more{to="/docs/guides/customize-the-lightbox" title="Customize the built-in lightbox"}
:::
...
:::read-more{to="/docs/overview/how-it-works" title="Layers of the API"}
:::

:::read-more{to="/docs/api/photo-group" title="Share a lightbox across albums"}
:::
