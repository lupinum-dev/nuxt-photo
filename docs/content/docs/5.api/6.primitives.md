...
::info
If you are new to the primitives, start with the [custom lightbox guide](/docs/guides/customize-the-lightbox). It explains the smallest working example step by step.
::
