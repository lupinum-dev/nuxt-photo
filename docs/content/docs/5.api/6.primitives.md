...
If you're new to the primitives, start with the [custom lightbox guide](/docs/guides/customize-the-lightbox) - it walks through the smallest working example step by step.
::
...
:::read-more{to="/docs/guides/customize-the-lightbox" title="Customize the lightbox"}
:::

:::read-more{to="/docs/api/composables" title="Composables API"}
:::

:::read-more{to="/docs/concepts/customization-layers" title="Customization layers"}
:::
