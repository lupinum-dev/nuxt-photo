...
Swipe, pinch-zoom, pan, wheel zoom, keyboard zoom, and drag-to-close all come for free — they attach to `<LightboxViewport>`. You don't need to wire pointer events yourself.
