---
title: Configuration and labels
...
[CSS reference and custom theming](/docs/reference/css)
...
[How image providers work](/docs/concepts/image-delivery)
...
Use [the `PhotoItem` model](/docs/concepts/photo-data-and-dimensions) to supply the required identifiers, dimensions, and sources.
