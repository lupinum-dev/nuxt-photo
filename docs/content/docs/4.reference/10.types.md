...
- [PhotoItem concept page](/docs/concepts/photo-data-and-dimensions)
...
Controls how collection components handle invalid photo data.
...
[Configuration and labels](/docs/reference/configuration-and-labels#labels) is the canonical
...
- [Transitions](/docs/concepts/lightbox-gestures-and-accessibility)
...
- [Responsive parameters](/docs/concepts/layouts-and-responsive-values)
