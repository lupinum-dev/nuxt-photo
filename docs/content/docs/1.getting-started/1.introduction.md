...
The lightbox supports pinch-to-zoom, pan, swipe, and spring-physics FLIP transitions. The module auto-imports components and prefixed helpers by default, detects `@nuxt/image`, and routes thumbnails and slides through it when it is installed.
