...
| `@nuxt-photo/core` | `import * as core`       |                   `7.00 kB` |
| `@nuxt-photo/vue`  | `import { useLightbox }` |                     `646 B` |
| `@nuxt-photo/vue`  | `import { PhotoImage }`  |                     `722 B` |
| `@nuxt-photo/vue`  | `import * as NuxtPhoto`  |                   `22.7 kB` |
| `@nuxt-photo/nuxt` | module enabled, no usage |  `≈ 0 B` (`+13 B` measured) |
| `@nuxt-photo/nuxt` | one `PhotoImage` usage   | `≈ 0 B` (`+110 B` measured) |
...
- Treat tiny negative Nuxt deltas as fixture noise around zero, not as a claim that the module makes bundles smaller.
