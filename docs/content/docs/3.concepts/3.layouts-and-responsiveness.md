...
`@nuxt-photo/vue` only in a plain Vue app.
...
:::read-more{to="/docs/concepts/ssr-and-layout-stability" title="SSR, CLS, and defaultContainerWidth"}
:::
...
:::read-more{to="/docs/api/composables" title="responsive() signature"}
:::

:::read-more{to="/docs/guides/tune-a-responsive-album" title="Tuning responsive layouts"}
:::
