...
description: Choose native image delivery, Nuxt Image, or one deterministic custom adapter.
---
...
:::read-more{to="/docs/concepts/image-pipeline" title="Integrate @nuxt/image"}
:::

:::read-more{to="/docs/guides/integrate-a-custom-image-service" title="Write a custom image adapter"}
:::

:::read-more{to="/docs/api/types" title="ImageAdapter type reference"}
:::
