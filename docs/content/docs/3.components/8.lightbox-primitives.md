...
The built-in lightbox isn't magic — it's a small set of primitives composed together. Import them from `@nuxt-photo/vue` and you can build your own lightbox with any UI you want, reusing the Vue lightbox runtime for gestures, FLIP transitions, and zoom.
