...
[the built-in lightbox slots](/docs/guides/customize-the-built-in-lightbox) instead.
...
Use [the primitives reference](/docs/reference/primitives) for exact props and slot
contracts.
