...
The container width is snapped to the nearest breakpoint before being passed to the responsive functions. See [SSR and Performance](/guides/ssr-and-performance) for more details.
