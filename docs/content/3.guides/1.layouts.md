...
Want to know how the Knuth-Plass DP finds optimal row breaks, how the column shortest-path works, or what the masonry local search does? See the [Layout Algorithms deep dive](/advanced/layout-algorithms).
