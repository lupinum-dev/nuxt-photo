...
The ghost image is rendered by the [`LightboxPortal`](/components/primitives#lightboxportal) component. During the transition, the source thumbnail is hidden (opacity: 0) to avoid visual duplication.
