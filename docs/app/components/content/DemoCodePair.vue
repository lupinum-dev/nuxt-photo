...
<template>
  <div
    class="not-prose my-6 rounded-lg border border-default overflow-hidden bg-default"
  >
    <div
      class="flex items-center gap-1 px-2 py-2 border-b border-default bg-elevated/40"
    >
      <UButton
        label="Preview"
        icon="i-lucide-eye"
    ...
    <div
      v-show="active === 'code'"
      class="[&_pre]:!m-0 [&_pre]:!rounded-none [&_pre]:!border-0"
    >
      <slot name="code" />
    </div>
  </div>
